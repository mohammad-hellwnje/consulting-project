...
const WorkshopSpecificBookingsTable: React.FC = () => {
  ...
  const fetchData = async () => {
    ...
    setLoading(true);
    try {
      const [bookingsData, workshopData] = await Promise.all([
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      ...
      >
        ...
        <span>العودة للورش</span>
      </button>

      <h2 className="text-2xl font-bold mb-2 text-gray-800">
        حجوزات الورشة: {workshop?.title}
      </h2>
...
export default WorkshopSpecificBookingsTable;
