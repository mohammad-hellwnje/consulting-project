...
const FnjanEventBookingsTable: React.FC = () => {
  ...
  const fetchBookings = async () => {
    setLoading(true);
    try {
      const data = await getAllFnjanEventBookings();
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold mb-6 text-gray-800">إدارة حجوزات فعاليات فنجان</h2>
      ...
      >
        {selectedBooking && (
          <div className="space-y-3 text-gray-700">
            ...
            <p>
              <strong>الفعالية:</strong> {selectedBooking.event?.title}
            </p>
            <p>
...
export default FnjanEventBookingsTable;
