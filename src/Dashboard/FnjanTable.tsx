...
const FnjanTable: React.FC = () => {
  ...
  const fetchEvents = async () => {
    ...
    try {
      ...
      const eventsWithDefaults = data.map((e: FnjanEvent) => ({
        ...e,
        date: e.date || "",
  ...
  const handleView = (event: FnjanEvent) => {
    ...
    <div className="mt-8">
      ...
      >
        {selectedEvent && (
          <div className="space-y-3 text-gray-700">
            <p>
              <strong>العنوان:</strong> {selectedEvent.title}
            </p>
            <p>
              <strong>الوصف:</strong> {selectedEvent.description}
            </p>
            <p>
              <strong>السعر:</strong> {selectedEvent.price} ل.س
            </p>
            <p>
              <strong>الموقع:</strong> {selectedEvent.location || "-"}
            </p>
            <p>
              <strong>المدة:</strong> {selectedEvent.duration || "-"}
            </p>
            <p>
              <strong>عدد المقاعد:</strong> {selectedEvent.seats}
            </p>
            <p>
      ...
      >
        <p className="text-gray-700 mb-4">
          هل أنت متأكد من حذف حدث الفنجان "
