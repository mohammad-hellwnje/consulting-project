...
const InPersonCourseSpecificBookingsTable: React.FC = () => {
  ...
  const fetchData = async () => {
    ...
    setLoading(true);
    try {
      const [bookingsData, courseData] = await Promise.all([
        getInPersonCourseBookings(courseId),
        getInPersonCourseById(courseId),
      ]);
...
export default InPersonCourseSpecificBookingsTable;
