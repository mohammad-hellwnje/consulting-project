  ...
  return (
    <div className="flex flex-col gap-6 p-6 bg-white rounded-2xl shadow-md border border-gray-200">
      <h2 className="text-2xl font-semibold text-gray-800 mb-2">
        {mode === "add" ? "إضافة حدث فنجان جديد" : "تعديل حدث الفنجان"}
      </h2>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
        ...
        <div className="flex items-center gap-2">
          <div className="w-1/2">
            <Label label="عنوان الحدث" />
            <Input
              name="title"
              value={formData.title}
              onChange={handleChange}
              placeholder="اضف عنوان للحدث"
              required
            />
          </div>
          <div className="w-1/2">
        ...
        <div className="flex flex-col h-full lg:flex-row justify-between gap-6">
          <div className="w-1/2">
            ...
            <textarea
              ...
              placeholder="اضف شرح يوصّف الحدث"
              required
            />
          </div>

          <div className="w-1/2 flex flex-col">
            <Label label="صورة الحدث" />
