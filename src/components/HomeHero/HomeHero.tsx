...
export default function HomeHero() {
  return (
    <section className="h-screen w-full 2xl:px-[115px] lg:px-[100px] justify-start  items-end bg-top  bg-no-repeat gap-20 2xl:gap-40  flex  "> 
      <div className='w-[32%] h-full flex items-end justify-end'>
        <img src={woman} className='2xl:h-[700px] h-[500px]  w-full' alt="رضا محتسب" />
      </div>
      <div className=' w-[61%] flex flex-col justify-end h-full'>
        ...
        <div className=' w-full flex items-center justify-end gap-8 lg:my-20 2xl:my-[150px]'>
